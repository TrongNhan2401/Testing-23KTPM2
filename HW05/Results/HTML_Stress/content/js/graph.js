...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 50.0, "minX": 0.0, "maxY": 50.0, "series": [{"data": [[0.0, 50.0]], "isOverall": false, "label": "POST /api/login (new password)", "isController": false}, {"data": [[0.0, 50.0]], "isOverall": false, "label": "Stress_ResetPassword", "isController": true}, {"data": [[0.0, 50.0]], "isOverall": false, "label": "POST /api/forgot-password", "isController": false}, {"data": [[0.0, 50.0]], "isOverall": false, "label": "POST /api/reset-password", "isController": false}, {"data": [[0.0, 50.0]], "isOverall": false, "label": "POST /api/login (correct password)", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.7499999999999998, "minX": 1.78701096E12, "maxY": 1.7882882882882882, "series": [{"data": [[1.78701096E12, 1.7499999999999998], [1.78701102E12, 1.7882882882882882]], "isOverall": false, "label": "Stress Test - Reset Password (50 VUs)", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78701102E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 1.9387755102040818, "minX": 1.0, "maxY": 21.0, "series": [{"data": [[2.0, 1.9387755102040818], [1.0, 2.0]], "isOverall": false, "label": "POST /api/login (new password)", "isController": false}, {"data": [[1.98, 1.9400000000000002]], "isOverall": false, "label": "POST /api/login (new password)-Aggregated", "isController": false}, {"data": [[2.0, 20.142857142857146], [1.0, 21.0]], "isOverall": false, "label": "Stress_ResetPassword", "isController": true}, {"data": [[1.98, 20.160000000000004]], "isOverall": false, "label": "Stress_ResetPassword-Aggregated", "isController": true}, {"data": [[1.0, 7.8]], "isOverall": false, "label": "POST /api/forgot-password", "isController": false}, {"data": [[1.0, 7.8]], "isOverall": false, "label": "POST /api/forgot-password-Aggregated", "isController": false}, {"data": [[2.0, 7.755102040816326], [1.0, 9.0]], "isOverall": false, "label": "POST /api/reset-password", "isController": false}, {"data": [[1.98, 7.779999999999999]], "isOverall": false, "label": "POST /api/reset-password-Aggregated", "isController": false}, {"data": [[1.0, 2.0], [2.0, 2.6530612244897958]], "isOverall": false, "label": "POST /api/login (correct password)", "isController": false}, {"data": [[1.98, 2.6399999999999997]], "isOverall": false, "label": "POST /api/login (correct password)-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 2.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 88.03333333333333, "minX": 1.78701096E12, "maxY": 1446.6666666666667, "series": [{"data": [[1.78701096E12, 179.16666666666666], [1.78701102E12, 1446.6666666666667]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.78701096E12, 88.03333333333333], [1.78701102E12, 716.1333333333333]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78701102E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 1.9111111111111105, "minX": 1.78701096E12, "maxY": 20.333333333333332, "series": [{"data": [[1.78701096E12, 2.2], [1.78701102E12, 1.9111111111111105]], "isOverall": false, "label": "POST /api/login (new password)", "isController": false}, {"data": [[1.78701096E12, 20.333333333333332], [1.78701102E12, 20.136363636363637]], "isOverall": false, "label": "Stress_ResetPassword", "isController": true}, {"data": [[1.78701096E12, 8.5], [1.78701102E12, 7.704545454545457]], "isOverall": false, "label": "POST /api/forgot-password", "isController": false}, {"data": [[1.78701096E12, 7.2], [1.78701102E12, 7.844444444444445]], "isOverall": false, "label": "POST /api/reset-password", "isController": false}, {"data": [[1.78701096E12, 2.3333333333333335], [1.78701102E12, 2.681818181818182]], "isOverall": false, "label": "POST /api/login (correct password)", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78701102E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 1.9111111111111105, "minX": 1.78701096E12, "maxY": 20.333333333333332, "series": [{"data": [[1.78701096E12, 2.2], [1.78701102E12, 1.9111111111111105]], "isOverall": false, "label": "POST /api/login (new password)", "isController": false}, {"data": [[1.78701096E12, 20.333333333333332], [1.78701102E12, 20.090909090909086]], "isOverall": false, "label": "Stress_ResetPassword", "isController": true}, {"data": [[1.78701096E12, 8.5], [1.78701102E12, 7.659090909090908]], "isOverall": false, "label": "POST /api/forgot-password", "isController": false}, {"data": [[1.78701096E12, 7.2], [1.78701102E12, 7.844444444444445]], "isOverall": false, "label": "POST /api/reset-password", "isController": false}, {"data": [[1.78701096E12, 2.3333333333333335], [1.78701102E12, 2.681818181818182]], "isOverall": false, "label": "POST /api/login (correct password)", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78701102E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.78701096E12, "maxY": 0.8333333333333334, "series": [{"data": [[1.78701096E12, 0.0], [1.78701102E12, 0.0]], "isOverall": false, "label": "POST /api/login (new password)", "isController": false}, {"data": [[1.78701096E12, 0.8333333333333334], [1.78701102E12, 0.7727272727272727]], "isOverall": false, "label": "Stress_ResetPassword", "isController": true}, {"data": [[1.78701096E12, 0.0], [1.78701102E12, 0.0]], "isOverall": false, "label": "POST /api/forgot-password", "isController": false}, {"data": [[1.78701096E12, 0.0], [1.78701102E12, 0.0]], "isOverall": false, "label": "POST /api/reset-password", "isController": false}, {"data": [[1.78701096E12, 0.8333333333333334], [1.78701102E12, 0.7727272727272727]], "isOverall": false, "label": "POST /api/login (correct password)", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78701102E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.78701096E12, "maxY": 13.0, "series": [{"data": [[1.78701096E12, 13.0], [1.78701102E12, 11.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.78701096E12, 8.7], [1.78701102E12, 8.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.78701096E12, 13.0], [1.78701102E12, 10.210000000000008]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.78701096E12, 12.399999999999991], [1.78701102E12, 9.0]], "isOverall": false, "label": "95th percentile", "isController": false}, {"data": [[1.78701096E12, 2.0], [1.78701102E12, 1.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.78701096E12, 4.0], [1.78701102E12, 4.5]], "isOverall": false, "label": "Median", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78701102E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 4.0, "minX": 2.0, "maxY": 5.0, "series": [{"data": [[2.0, 5.0], [4.0, 4.5], [3.0, 4.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 4.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 4.0, "minX": 2.0, "maxY": 5.0, "series": [{"data": [[2.0, 5.0], [4.0, 4.5], [3.0, 4.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 4.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 0.36666666666666664, "minX": 1.78701096E12, "maxY": 2.966666666666667, "series": [{"data": [[1.78701096E12, 0.36666666666666664], [1.78701102E12, 2.966666666666667]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78701102E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 0.36666666666666664, "minX": 1.78701096E12, "maxY": 2.966666666666667, "series": [{"data": [[1.78701096E12, 0.36666666666666664], [1.78701102E12, 2.966666666666667]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78701102E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 0.08333333333333333, "minX": 1.78701096E12, "maxY": 0.75, "series": [{"data": [[1.78701096E12, 0.08333333333333333], [1.78701102E12, 0.75]], "isOverall": false, "label": "POST /api/login (new password)-success", "isController": false}, {"data": [[1.78701096E12, 0.1], [1.78701102E12, 0.7333333333333333]], "isOverall": false, "label": "Stress_ResetPassword-success", "isController": true}, {"data": [[1.78701096E12, 0.08333333333333333], [1.78701102E12, 0.75]], "isOverall": false, "label": "POST /api/reset-password-success", "isController": false}, {"data": [[1.78701096E12, 0.1], [1.78701102E12, 0.7333333333333333]], "isOverall": false, "label": "POST /api/forgot-password-success", "isController": false}, {"data": [[1.78701096E12, 0.1], [1.78701102E12, 0.7333333333333333]], "isOverall": false, "label": "POST /api/login (correct password)-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78701102E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 0.4666666666666667, "minX": 1.78701096E12, "maxY": 3.7, "series": [{"data": [[1.78701096E12, 0.4666666666666667], [1.78701102E12, 3.7]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78701102E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
