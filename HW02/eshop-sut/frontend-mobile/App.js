...
const API_URL = "http://192.168.1.165:3000/api"; // IP LAN để chạy được trên iOS/Android và thiết bị thật
          ...
          <View style={styles.checkoutCard}>
            ...
            <View style={styles.couponBox}>
              ...
              <View style={styles.searchRow}>
                ...
                />
                <TouchableOpacity
                  style={[styles.orangeButton, (!couponCode.trim() || applyingCoupon) && styles.disabledButton]}
            ...
            <Text style={styles.finalTotal}>
              Tổng thanh toán: {formatMoney(couponResult ? couponResult.final_amount : cartTotal)}
            </Text>
            <TouchableOpacity
              style={[styles.checkoutBtn, checkoutLoading && styles.disabledButton]}
